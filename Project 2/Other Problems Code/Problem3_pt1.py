def find_max_sublist(nums):
    ...
    for i in range(2, len(nums)):
        ...
        if max_list == nums[i]: #update the new start of a list by the update of max_list
            start = i
            end = i
...
max_sum, max_sublist = find_max_sublist(nums)
print("Maximum value of the sublist:", max_sum)
print("Sublist with maximum sum:", max_sublist)